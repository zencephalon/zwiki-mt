...
function seedData() {
  ...
  var index = Wiki.create({title: "Zencephalon", text: "I follow <a href='" + luvism._id + "'>luvism</a> and my <a href='" + guiding_principles._id + "'>guiding principles</a>.", root: true, uid: uid});
}
